    ...
    <div class="row justify-content-between align-items-center align-items-xl-end">
      ...
      <div class="col-lg-6 col-xxl-5 py-5 py-lg-6 my-lg-5 text-center text-lg-start">
        ...
        <p id="intro" class="lead fw-normal mb-5" data-i18n="intro">
          Kenapa harus bayar penuh kalau Anda bisa berbagi pengalaman? Dengan PatunganYuk!, Anda bisa menikmati
        ...
        <a href="https://app.patunganyuk.com/user/register?utm_medium=social&utm_source=google&utm_campaign=promotion&utm_term=getstarted-patunganyuk&utm_content=register"
          class="button button-large px-lg-5 py-lg-3 rounded-pill m-0 mb-4"><i class="fa-solid fa-star"></i>Get
          Started</a>
        ...
        <div class="row align-items-center gy-3">
          ...
          <div class="col-lg-8">
            <div class="row g-4 align-items-center justify-content-center">
              ...
              <div class="col-md-2 col-4 flex-fill text-center op-08"><img class=""
                  src="demos/saas-2/images/clients/microsoft.png" title="Service PatunganYuk - Microsoft"
                  alt="Service Patunganyuk - Microsoft"></div>
              <div class="col-md-2 col-4 flex-fill text-center op-08"><img class=""
      ...
      <div class="container">
          ...
          <div class="col-md-5">
            <ul class="swiper-links-container list-unstyled">
              <li class="swiper-tab-link active">
                ...
                <p class="swiper-tab-content" data-i18n="steps_content_1">Mulai dengan mendaftar di PatunganYuk!
                  dengan mengisi data pribadi Anda. Masukkan nama, email, dan informasi lainnya yang diperlukan
                  untuk membuat akun Anda. Prosesnya cepat dan mudah, memastikan Anda siap untuk berbagi layanan
              ...
              <li class="swiper-tab-link">
                ...
                <p class="swiper-tab-content" data-i18n="steps_content_2">Setelah akun Anda siap, pilih layanan
                  streaming yang ingin Anda bagikan. Baik itu Netflix, Spotify, Disney+, atau layanan lain, Anda
                  dapat memilih dan menemukan mitra berbagi yang sesuai dengan preferensi Anda. Kami menawarkan
                  berbagai opsi untuk memastikan Anda mendapatkan manfaat terbaik dari setiap layanan.</p>
                <div class="swiper-pagination-progress">
                  <span class="swiper-pagination-bar"></span>
                  <span class="swiper-pagination-bar-active"></span>
                </div>
              ...
              <li class="swiper-tab-link">
                ...
                <p class="swiper-tab-content" data-i18n="steps_content_3">Selesaikan proses dengan melakukan
                  pembayaran. Setelah pembayaran selesai, Anda dapat segera mulai menikmati layanan streaming yang
              ...
              <div class="swiper swiper-tab-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    ...
                    <dotlottie-player src="json/choosing_career.json" background="transparent" speed="1"
                      style="width: 800px;" loop autoplay>
                    </dotlottie-player>
                  </div>
                  <div class="swiper-slide">
                    <!-- <img
                          ...
                          alt="How to order in Patungan Yuk" title="How to order in Patungan Yuk"
                          class="w-100 rounded-xxl "> -->
                    <dotlottie-player src="json/pay_qr.json" background="transparent" speed="1" style="width: 600px;"
                      loop autoplay>
                    </dotlottie-player>
                  </div>
                </div>
        ...
        <div class="row justify-content-center mt-lg-6 mt-5" id="services-product">
          <div class="col-lg-8 text-center">
            <h3 class="display-4 fw-bolder mb-3 ls-n-2" data-i18n="best_product_title">Produk Terbaik Kami</h3>
            <p class="lead mb-5 mb-lg-6" data-i18n="best_product_content">Nikmati layanan streaming premium seperti
              Netflix dan Spotify dengan harga yang lebih terjangkau. Dengan PatunganYuk!, bagikan langganan dengan
              mudah, kelola akun dengan aman, dan dapatkan nilai terbaik untuk uang Anda. Bergabunglah dengan kami
            ...
            <div class="row align-items-stretch g-4">
                ...
                <div class="d-flex p-5 position-relative bg-contrast-200 flex-column h-100 overflow-hidden"
                  ...
                  <div class="row">
                    <div class="col-xl-7 col-md-8">
                      <span class="badge rounded-pill text-bg-light px-3 py-2 mb-2 fw-normal">Netflix</span>
                      <h3 class="fs-2 mb-3 fw-bolder" data-i18n="netflix_title">
                        Hiburan Tak Terbatas, Semua dalam Satu Tempat, Dibagikan dengan Teman
                      </h3>
                      <div>
                        <a href="https://s.id/netflix-duo-1-pty?utm_medium=social&utm_source=website&utm_campaign=patunganyuk-netflix&utm_term=contact-patunganyuk"
                  ...
                  <svg class="d-none d-md-block" viewBox="0 0 300 300" width="380" height="380"
                    ...
                    <path fill="#564d4d" d="M272.9 27.1c0 135.76-110.04 245.8-245.8 245.8V27.1h245.8z"></path>
                    <path fill="#000" d="M232.75 27.1c0 113.59-92.06 205.65-205.65 205.65V27.1h205.65z"></path>
                    <path fill="#db0000" d="M188.88 27.1c0 89.36-72.43 161.78-161.78 161.78V27.1h161.78z"></path>
                  </svg>
                </div>
              </div>
              ...
              <div class="col-xl-5">
                <div class="d-flex p-5 position-relative bg-contrast-200 flex-column h-100 overflow-hidden"
                  style="border-radius: 20px;">
                  <div>
                    <span class="badge rounded-pill text-bg-light px-3 py-2 mb-2 fw-normal">Spotify</span>
                  </div>
                  <h3 class="fs-2 mb-3 fw-bolder" data-i18n="spotify_title">Temukan, Streaming, dan Bagikan – dengan
                    Biaya yang Lebih Terjangkau</h3>
                  <div>
                    <a href="https://s.id/spotify-pr-1-pty?utm_medium=social&utm_source=website&utm_campaign=patunganyuk-spotify&utm_term=contact-patunganyuk"
                      class="button button-large button-border button-dark button-black rounded-pill m-0">Discover
                      Spotify</a>
                  </div>
              ...
              <div class="col-xl-5">
                <div class="d-flex p-5 position-relative bg-contrast-200 flex-column h-100 overflow-hidden"
                  ...
                  <div class="position-relative z-1">
                    <div>
                      <span class="badge rounded-pill text-bg-light px-3 py-2 mb-2 fw-normal">Youtube</span>
                    </div>
                    <h3 class="fs-2 mb-3 fw-bolder" data-i18n="youtube_title">Jelajahi Dunia Video, Bagikan
                      Pengalaman</h3>
                    <div>
                      <a href="#"
                        class="button button-large button-border button-dark button-black rounded-pill m-0">Discover
              ...
              <div class="col-xl-7">
                <div class="d-flex p-5 position-relative bg-contrast-200 flex-column h-100 overflow-hidden"
                  ...
                  <div class="position-relative z-1">
                    <div>
                      <span class="badge rounded-pill text-bg-light px-3 py-2 mb-2 fw-normal">Canva</span>
                    </div>
                    <h3 class="fs-2 mb-3 fw-bolder" data-i18n="canva_title">Desain Apa Saja, Bagikan dengan Indah
                    </h3>
                    <div>
                      <a href="https://s.id/canva-1-pty?utm_medium=social&utm_source=website&utm_campaign=patunganyuk-canva&utm_term=contact-patunganyuk"
                        class="button button-large button-border button-dark button-black rounded-pill m-0">Discover
                        Canva</a>
                    </div>
                  </div>
                  <svg class="d-none d-md-block" viewBox="0 0 300 300" width="280" height="280"
                    ...
                    <path fill="#564d4d" d="M272.9 27.1c0 135.76-110.04 245.8-245.8 245.8V27.1h245.8z"></path>
                    <path fill="#000" d="M232.75 27.1c0 113.59-92.06 205.65-205.65 205.65V27.1h205.65z"></path>
                    <path fill="#7df9ff" d="M188.88 27.1c0 89.36-72.43 161.78-161.78 161.78V27.1h161.78z"></path>
                  </svg>
                </div>
              </div>
                ...
                <div class="card rounded-xxl bg-contrast-200 border-0">
                  <div class="card-body p-5">
                    <div class="row align-items-center">
                      <div class="col-md-6">
                        <div>
                          <span class="badge rounded-pill text-bg-light px-3 py-2 mb-3 fw-normal">365
                            Solutions</span>
                        </div>
                        <h3 class="display-5 fw-bolder ls-n-2" data-i18n="microsoft365_title">ekerja dan
                          Berkolaborasi Secara Efisien, Dimana Saja</h3>
                        <p data-i18n="microsoft365_subtitle">
                          Dengan PatunganYuk!, bagikan biaya Microsoft 365 dan akses alat penting seperti Word,
                          Excel, dan PowerPoint. Nikmati penyimpanan cloud dan kolaborasi tanpa harga mahal. Mulai
                          berbagi hari ini dan tingkatkan produktivitas dengan biaya terjangkau.
                        </p>
                        <a href="https://s.id/365-pr-1-pty?utm_medium=social&utm_source=website&utm_campaign=patunganyuk-microsoft365&utm_term=contact-patunganyuk"
                      ...
                      <div class="col-md-6">
                        ...
                        <dotlottie-player src="json/employee_presenting_data.json" background="transparent" speed="1"
                          style="width: 500px;" loop autoplay>
                        </dotlottie-player>
                      </div>
                    </div>
                    ...
                    <div class="row gy-5">
                      <div class="col-lg-3">
                        <h3 class="fw-bold ls-n-1 fs-1 lh-sm" data-i18n="core_features">Our Core Features</h3>
                      </div>

                      <div class="col-lg-3">
                        <img class="" src="demos/saas-2/images/svg/analysis.svg" alt="Features in PatunganYuk"
                          title="Features in PatunganYuk" height="52">
                        <h4 class="mt-4 mb-2 fs-5 fw-bold" data-i18n="coreFeat_title_1">Manajemen Akun</h4>
                        <p class="mb-0" data-i18n="coreFeat_content_1">
                          Mudah ngatur akun bareng, pembayaran, dan akses anggota lewat platform kami yang gampang
                          dipakai.
                        </p>
                      </div>
                      <div class="col-lg-3">
                        <img class="" src="demos/saas-2/images/svg/paybill.svg" alt="Features in PatunganYuk"
                          title="Features in PatunganYuk" height="52">
                        <h4 class="mt-4 mb-2 fs-5 fw-bold" data-i18n="coreFeat_title_2">Berbagi Langganan</h4>
                        <p class="mb-0" data-i18n="coreFeat_content_2">Bagikan biaya layanan streaming dan langganan
                          lainnya dengan teman-teman secara efisien.</p>
                      </div>

                      <div class="col-lg-3">
                        <img class="" src="demos/saas-2/images/svg/install.svg" alt="Features in PatunganYuk"
                          title="Features in PatunganYuk" height="52">
                        <h4 class="mt-4 mb-2 fs-5 fw-bold" data-i18n="coreFeat_title_3">Kolaborasi Tanpa Ribet</h4>
                        <p class="mb-0" data-i18n="coreFeat_content_3">Terhubung dengan teman, bagikan langganan,
      ...
      <div class="container">
        <div class="text-center">
          ...
          <p class="lead mb-5 mb-lg-6" data-i18n="pricingDescription">
            Nikmati akses ke platform streaming top seperti Netflix, Spotify, dan lainnya dengan rencana harga kami
        ...
        <div class="pricing-tenure-switcher font-primary row align-items-center justify-content-center mb-4"
          ...
          <div class="col-auto">
            <div class="btn-group rounded-pill position-relative" role="group"
              ...
              <input type="radio" class="btn-check" name="switch-toggle-radio" id="switch-toggle-monthly" checked
                value="monthly">
          ...
          <div class="col-xl-5 col-md-6">
            ...
            <div class="pricing-box position-relative rounded-xxl p-5 h-100 d-flex flex-column bg-contrast-0">
                ...
                <div class="col-lg-6">
                  <div class="pricing-price fw-bolder text-lg-end pt-lg-0 pb-0">
                    ...
                    <div class="pts-content pts-content-annually">90K<span
                        class="d-block fs-6 fw-semibold op-05 mb-0 mt-2">per 3 months</span></div>
                  </div>
                </div>
              </div>
              <div class="pricing-features bg-transparent border-bottom-0 border-width-2 border-black mt-5 pt-5 pb-3">
                ...
                <ul class="iconlist">
                  <li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>1</strong> Profile
                      Semi-Private</span></li>
                  <li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>4K Ultra HD +
                        HDR</strong></span></li>
                  <li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>Spatial Audio</strong>
                      (Immersive Sound)</span></li>
                  <li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>2</strong> Supported Devices
                      (TV, Computer, Mobile Phone, & Tablet)</span></li>
                  <li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>3</strong> Downloaded
                      Devices</span></li>
                </ul>
              ...
              <img src="demos/saas-2/images/svg/pricing-bg.svg" title="Pricing Patungan" alt="Pricing Patungan"
                class="pricing-bg ">
            </div>
            ...
            <div class="pricing-box rounded-xxl p-5 h-100 d-flex flex-column border-0 bg-color bg-opacity-10">
              <div class="row align-items-center">
                <div class="col-lg-6">
                  ...
                  <p class="mb-0 small lh-base text-contrast-700">Your Music, Your Way – With Friends</p>
                </div>
              ...
              <div class="pricing-features bg-transparent border-bottom-0 border-width-2 border-dark mt-5 pt-5 pb-3">
                <p class="lead fw-bold mb-3">Included:</p>
                <ul class="iconlist">
                  <li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>Login</strong> with your
                      personal account, not someone else's</span></li>
                  <li class="my-1"><i class="bi-patch-check-fill"></i> <span><strong>Invitation link</strong> to
    ...
    <div id="section-faqs" class="page-section my-5">
      <div class="container">
        <div class="row justify-content-between position-relative">
          <div class="col-lg-5">
            <h3 class="display-3 ls-n-3 fw-bolder mb-3" data-i18n="faq_title">Pertanyaan yang Sering Diajukan</h3>
            <p class="lead op-08 mb-5" data-i18n="faq_description">Temukan jawaban cepat untuk pertanyaan umum Anda
              dan lihat bagaimana PatunganYuk! dapat meningkatkan pengalaman streaming Anda. Tim dukungan kami siap
              membantu jika diperlukan.</p>
            <!-- <img class="" src="demos/saas-2/images/svg/faqs.svg" title="FAQs PatunganYuk" alt="FAQs PatunganYuk"> -->
            <dotlottie-player src="json/faq.json" background="transparent" speed="1" style="height: 500px;" loop
              autoplay>
            </dotlottie-player>
          </div>
          ...
          <div id="section-blog" class="page-section pb-5"
            ...
            <div class="container py-5">
              <div class="row justify-content-center text-center p-lg-6 p-5 rounded-xxl gx-0 dark mt-5 mt-lg-6"
                ...
                <div class="col-lg-8 text-center">
                  <div class="position-relative z-1">
                    <h3 class="display-4 fw-bolder text-white mb-3 ls-n-1" data-i18n="callToAction"></h3>
