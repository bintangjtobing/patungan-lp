        ...
        <footer id="footer" class="bg-white border-0">
                ...
                <div class="row gx-4 gy-5">
                  ...
                  <div class="col-lg-3 col-6">
                    <div class="widget widget_links widget-li-noicon">
                      <h4 class="fw-bolder text-contrast-1000 text-smaller text-uppercase mb-4">Help & Support</h4>
                      <ul>
                  ...
                  <div class="col-lg-3 col-6">
                    <div class="widget widget_links widget-li-noicon">
                      <h4 class="fw-bolder text-contrast-1000 text-smaller text-uppercase mb-4">Get Started</h4>
                      <ul>
                        <li><a
                  ...
                  <div class="col-lg-3 col-md-12 col-12">
                    <div class="widget">
                      ...
                      <ul class="list-unstyled">
                        ...
                        <li class="mb-3"><i class="me-3 color bi-calendar-week-fill"></i>Mon - Sat | 08:00 - 23:00</li>
            ...
            <div id="copyrights" class="bg-transparent border-top op-08">
              <div class="container text-center">
                ...
                Copyrights &copy; 2024 All Rights Reserved by PatunganYuk IDN. Supported by PT. Boxity Central Indonesia.
