  ...
  return {
    ...
    Menus: (function () {
      ...
      var _hover = function () {
        ...
        // Ambil nilai dari style dengan default '666' jika tidak ditemukan
        var menuHoverDelay =
          getComputedStyle(__core.getVars.elHeader)
            .getPropertyValue("--cnvs-primary-menu-submenu-display-speed")
            .trim() || "666";

        // Pastikan menuHoverDelay adalah string dan tangani unit waktu
        if (typeof menuHoverDelay === "string") {
          if (menuHoverDelay.endsWith("ms")) {
            menuHoverDelay = menuHoverDelay.split("ms")[0];
          } else if (menuHoverDelay.endsWith("s")) {
            menuHoverDelay = menuHoverDelay.split("s")[0] * 1000;
          } else {
            // Tangani jika nilai tidak memiliki unit waktu, anggap sebagai milidetik
            menuHoverDelay = parseInt(menuHoverDelay, 10);
          }
        } else {
          // Jika bukan string, tetapkan nilai default
          menuHoverDelay = 666;
        }

        // Pastikan nilai menuHoverDelay adalah angka
        menuHoverDelay = Number(menuHoverDelay);
